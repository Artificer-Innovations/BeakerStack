...
- **Web components:** `@beakerstack/admin/web` (requires `react`, `react-dom`, and `react-router` v8+)

Peer dependencies use semver ranges (`^19.2.8`, `^8.3.0`) so consumers are not pinned to an exact patch release.
