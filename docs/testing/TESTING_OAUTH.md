...
Follow the setup instructions in [OAuth setup for production](../OAUTH.md) first, then:
...
3. ⏸️ Configure OAuth credentials (see [../OAUTH.md](../OAUTH.md))
...
4. Review [../OAUTH.md](../OAUTH.md) for configuration
