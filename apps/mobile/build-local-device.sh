#!/usr/bin/env bash
# Build script for local device builds
...
echo "🔨 Building iOS device build locally..."
...
npx eas build --platform ios --profile preview-device-local --local

echo ""
echo "✅ Build complete!"
echo ""
echo "To install on your connected iPhone:"
echo "  1. Find the .ipa file in the build output above"
echo "  2. Run: xcrun devicectl device install app --device <DEVICE_ID> <path-to-ipa>"
echo ""
echo "Or use the install script:"
echo "  ./install-local-device.sh <path-to-ipa>"
