...
function HookStatePanel() {
  ...
  const colCap = useFeature<typeof billingConfig, 'containers_per_account_max'>(
    'containers_per_account_max'
  );
  const itemCap = useFeature<typeof billingConfig, 'items_per_container_max'>(
    'items_per_container_max'
  );
  const featA = useFeature<typeof billingConfig, 'feature_a'>('feature_a');
  const featB = useFeature<typeof billingConfig, 'feature_b'>('feature_b');
